...
with col1:
    ...
    st.write('The value you are input is:', FS300Dwell_days)
    ...
    st.write('The value you are input is:',  Hipot_Result )
...
with col2:
    ...
    st.write('The value you are input is:', LamSimDwell_Attr)
    ...
    st.write('The value you are input is:',  IntensityVoltage)
with col3:
    st.text('Column 3')
    ...
    st.write('The value you are input is:',  BSAInterStageDwell)
with col4:
    st.text('Column 4')
    ...
    st.write('The value you are input is:',  rccc)
