...
with col2:
    # st.text('Column 2')
    Coater_Run  = st.number_input("Coater_Run ", min_value=80.0, max_value=110.0, value=80,step=1.0, format="%.2f", key="Coater_Run ", help="put your module Coater_Run", on_change=None, args=None, kwargs=None, placeholder="Please fill in this field", disabled=False, label_visibility="visible")
    ...
    Exsitu_Avg_Roughness  = st.number_input("Exsitu Avg. Roughness ", min_value=1000.0, max_value=1400.0, value=0.0,step=1.0, format="%.2f", key="Exsitu Avg. Roughness ", help="put your module Exsitu Avg. Roughness", on_change=None, args=None, kwargs=None, placeholder="Please fill in this field", disabled=False, label_visibility="visible")
    ...
    Exsitu_Roughness_Min  = st.number_input("Exsitu Roughness Min ", min_value=900.0, max_value=1400.0, value=0.0,step=1.0, format="%.2f", key="Exsitu Roughness Min ", help="put your module Exsitu Roughness Min", on_change=None, args=None, kwargs=None, placeholder="Please fill in this field", disabled=False, label_visibility="visible")
    Exsitu_Roughness_Max  = st.number_input("Exsitu Roughness Max", min_value=1000.0, max_value=1400.0, value=0.0,step=1.0, format="%.2f", key="Exsitu Roughness Max", help="put your module Exsitu Roughness Max", on_change=None, args=None, kwargs=None, placeholder="Please fill in this field", disabled=False, label_visibility="visible")
    Exsitu_Roughness_Arbr  = st.number_input("Roughness_Arbs ", min_value=50.0, max_value=12.0, value=0.0,step=0.1, format="%.2f", key="Roughness_Arbs", help="put your module Exsitu Roughness Arbr", on_change=None, args=None, kwargs=None, placeholder="Please fill in this field", disabled=False, label_visibility="visible")
